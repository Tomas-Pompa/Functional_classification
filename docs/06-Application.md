...
``` r
# ggsave("figures/kap7_tecator_box_test_neder_new.tex", device = tikz, width = 7, height = 5)
...
``` r
# ggsave("figures/kap7_tecator_box_test_der_new.tex", device = tikz, width = 7, height = 5)
